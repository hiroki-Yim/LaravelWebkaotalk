$(document).ready(function(){
    ...
    var path = "";
    switch(urlId){
      case temp+"board" : path="board"; break;
      case temp+"chats" : path="chats"; break;
      case temp+"/" : path= "index"; break;
      case temp+"find" : path="find"; break;
      case temp+"more" : path="more"; break;
      default : path="index";
    }
    var urlvalue = path;
