        ...
        <fieldset>
            <form action="{{route('board.update', ['board' => $msg['postid']])}}" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{$msg['title']}}" class="form-control" name="title" placeholder="TITLE" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}">                    @if ($errors->has('title'))
